...
import com.example.bus_app.student_se_one_qrcode

class citizen_se_one_pass : AppCompatActivity() {

    val multiValueMap: MutableMap<String, ArrayList<String>> = HashMap()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_citizen_se_one_pass)
...
//        multiValueMap["katrajnigdi"]!!.add("dangechowk-wakad-warje-ambegaon")
    ...
    private fun listdata(result: String) {
        ...
        listview.setOnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(applicationContext, citizen_se_one_qrcode::class.java)
