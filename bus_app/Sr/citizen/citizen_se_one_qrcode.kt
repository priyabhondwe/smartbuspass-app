...
class citizen_se_one_qrcode : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_citizen_se_one_qrcode)
        ...
        val name = mSharedPreference.getString("citizen-name", "DEFAULT")

        val km = multiValueMap[value]?.get(0)!!.toInt()

        val discount = km*5/100
        val result = km-discount
...
//        Toast.makeText(applicationContext, res, Toast.LENGTH_LONG).show()
        ...
        sb.append("Specific Route 1 Day Pass")
        sb.append(System.getProperty("line.separator"))
...
//        Toast.makeText(applicationContext, msg, Toast.LENGTH_LONG).show()
        ...
        btn.setOnClickListener {
            ...
            try{
                ...
                createImageFile(bmp)
                val s = "Specific Route 1 Day Pass "
