...
class citizen_se_moth_qrcode : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_citizen_se_moth_qrcode)
...
//        Toast.makeText(applicationContext, res, Toast.LENGTH_LONG).show()
        ...
        sb.append("Specific Route 28 Day Pass")
        sb.append(System.getProperty("line.separator"))
...
//        Toast.makeText(applicationContext, msg, Toast.LENGTH_LONG).show()
        ...
        btn.setOnClickListener {
            ...
            try{
                ...
                val s = "Specific Route 28 Day Pass "
