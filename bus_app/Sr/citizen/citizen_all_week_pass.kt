...
import com.example.bus_app.student_all_week_qrcode
import java.util.ArrayList
import java.util.HashMap

class citizen_all_week_pass : AppCompatActivity() {

    val multiValueMap: MutableMap<String, ArrayList<String>> = HashMap()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_citizen_all_week_pass)
    ...
    private fun listdata(result: String) {
        ...
        listview.setOnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(applicationContext, citizen_all_week_qrcode::class.java)
