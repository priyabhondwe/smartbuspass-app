...
import com.example.bus_app.sudent_se_week_qecode
import java.util.ArrayList
import java.util.HashMap

class citizen_se_week_pass : AppCompatActivity() {

    val multiValueMap: MutableMap<String, ArrayList<String>> = HashMap()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_citizen_se_week_pass)
    ...
    private fun listdata(result: String) {
        ...
        listview.setOnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(applicationContext, citizen_se_week_qrcode::class.java)
