...
import com.example.bus_app.student_all_month_qrcode
import java.util.ArrayList
import java.util.HashMap

class normal_all_monthpass : AppCompatActivity() {

    val multiValueMap: MutableMap<String, ArrayList<String>> = HashMap()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_normal_all_monthpass)
    ...
    private fun listdata(result: String) {
        ...
        listview.setOnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(applicationContext, normal_all_month_qrcode::class.java)
