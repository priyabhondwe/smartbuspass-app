...
class sudent_se_week_qecode : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sudent_se_week_qecode)
        ...
        val name = mSharedPreference.getString("key", "DEFAULT")
...
//        Toast.makeText(applicationContext, res, Toast.LENGTH_LONG).show()
        ...
        sb.append("Specific Route 7 Day Pass")
        sb.append(System.getProperty("line.separator"))
...
//        Toast.makeText(applicationContext, msg, Toast.LENGTH_LONG).show()
        ...
        btn.setOnClickListener {
            ...
            try{
                ...
                createImageFile(bmp)
                val s = "Specific Route 7 Day Pass "
