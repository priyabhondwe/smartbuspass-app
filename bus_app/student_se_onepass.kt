...
class student_se_onepass : AppCompatActivity() {

    val multiValueMap: MutableMap<String, ArrayList<String>> = HashMap()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_student_se_onepass)
...
//        multiValueMap["katrajnigdi"]!!.add("dangechowk-wakad-warje-ambegaon")
    ...
    private fun listdata(result: String) {
        ...
        listview.setOnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(applicationContext,student_se_one_qrcode::class.java)
